      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          //latency variables
          double lt_x = v*dt;
          double lt_psi = -(v/Lf)*delta*dt;
          double lt_v = v+prev_a*dt;
          double lt_cte = cte + v * sin(epsi) * dt;
          double lt_epsi = epsi + lt_psi;

          Eigen::VectorXd lt_state(6);
          lt_state << lt_x, 0, lt_psi, lt_v, lt_cte, lt_epsi;

          auto vars = mpc.Solve(lt_state, coeffs);
